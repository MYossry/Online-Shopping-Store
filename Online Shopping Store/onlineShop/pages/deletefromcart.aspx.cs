...
namespace onlineShop.pages
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=(local);Initial Catalog=OnlineShopStore;Integrated Security=True");
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.Close();
            //---------------------------------------------------
            SqlCommand cmd = new SqlCommand("deleetefromcart", con);
